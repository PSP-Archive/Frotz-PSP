...
// PSP Compatibility Seciton
#define fputs(str, fd)pspDebugScreenPrintf(str)
#define fputc(char, fd)pspDebugScreenPrintf("%c", char)
#define putchar(char)pspDebugScreenPrintf("%c", char)
#define fprintf pspDebugScreenPrintf
#define printf pspDebugScreenPrintf
#define atoi(str)0
#define getchar()psp__getchar
#define islower(char)(char >= 'a' && char <= 'z') ? 1 : 0
